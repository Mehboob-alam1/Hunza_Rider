package com.mehboob.hunzarider.recievers;
...
import com.mehboob.hunzarider.activities.NoNetworkActivity;
import com.mehboob.hunzarider.utils.SnackbarHelper;
...
//            showSnackBar((Activity) context,"You are online");
            ...
            SnackbarHelper.getInstance().showSnackbar("You are online !");
        } else {
